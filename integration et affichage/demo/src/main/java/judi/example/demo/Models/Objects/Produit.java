		...
		try {
            ...
            if(size==0){
                ...
                while(resultset.next()){
                    ...
                    produits[i].setId_produit(resultset.getInt("id_produit"));
                    produits[i].setDesignationProduit(resultset.getString("designation_produit"));
                    produits[i].setPrix(resultset.getDouble("prix"));
                    produits[i].setQualite(resultset.getDouble("qualite"));
                    i++;
                }
            }
			statement.close();
